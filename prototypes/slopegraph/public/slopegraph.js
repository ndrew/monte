...
var slopegraph = {main:{}};
slopegraph.main.X = cljs.core.sorted_map.call(null, "KEY1", "value1", "KEY2", "value2", "KEY2.SUBKEY1", "subvalue1");
slopegraph.main.Y = cljs.core.sorted_map.call(null, "NKEY1", "value1", "NKEY2", "value2", "NKEY2.SUBKEY1", "subvalue1");
slopegraph.main.X_Y_adjucency = cljs.core.PersistentVector.fromArray([cljs.core.PersistentVector.fromArray(["KEY1", "NKEY1"], !0), cljs.core.PersistentVector.fromArray(["KEY2", "NKEY2.SUBKEY1"], !0)], !0);
strokes.bootstrap.call(null);
slopegraph.main.m = cljs.core.PersistentVector.fromArray([50, 180, 50, 40], !0);
slopegraph.main.w = 960 - slopegraph.main.m.call(null, 1) - slopegraph.main.m.call(null, 3);
slopegraph.main.h = 500 - slopegraph.main.m.call(null, 0) - slopegraph.main.m.call(null, 2);
slopegraph.main.linear_scale = function(a) {
  return strokes.d3.scale.linear().domain(cljs.core.PersistentVector.fromArray([0, cljs.core.count.call(null, a)], !0)).range(cljs.core.PersistentVector.fromArray([slopegraph.main.m.call(null, 0), slopegraph.main.h], !0))
};
slopegraph.main.svg = strokes.d3.select("#slopegraph").append("svg").attr(cljs.core.ObjMap.fromObject(["\ufdd0'width", "\ufdd0'height"], {"\ufdd0'width":slopegraph.main.w + slopegraph.main.m.call(null, 1) + slopegraph.main.m.call(null, 3), "\ufdd0'height":slopegraph.main.h + slopegraph.main.m.call(null, 0) + slopegraph.main.m.call(null, 2)})).append("g").attr(cljs.core.ObjMap.fromObject(["\ufdd0'transform"], {"\ufdd0'transform":[cljs.core.str("translate("), cljs.core.str(slopegraph.main.m.call(null, 
3)), cljs.core.str(","), cljs.core.str(slopegraph.main.m.call(null, 0)), cljs.core.str(")")].join("")}));
slopegraph.main.header_X = slopegraph.main.svg.append("svg:text").attr(cljs.core.ObjMap.fromObject(["\ufdd0'x", "\ufdd0'y", "\ufdd0'text-anchor", "\ufdd0'opacity"], {"\ufdd0'x":slopegraph.main.m.call(null, 1), "\ufdd0'y":0, "\ufdd0'text-anchor":"end", "\ufdd0'opacity":0.5})).text("X");
slopegraph.main.header_Y = slopegraph.main.svg.append("svg:text").attr(cljs.core.ObjMap.fromObject(["\ufdd0'x", "\ufdd0'y", "\ufdd0'text-anchor", "\ufdd0'opacity"], {"\ufdd0'x":slopegraph.main.w - slopegraph.main.m.call(null, 3), "\ufdd0'y":0, "\ufdd0'text-anchor":"start", "\ufdd0'opacity":0.5})).text("Y");
var x_ids_68776 = cljs.core.keys.call(null, slopegraph.main.X), y_ids_68777 = cljs.core.keys.call(null, slopegraph.main.Y), ya_68778 = slopegraph.main.linear_scale.call(null, x_ids_68776), yb_68779 = slopegraph.main.linear_scale.call(null, y_ids_68777), X_indexes_68780 = cljs.core.reduce.call(null, cljs.core.merge, cljs.core.map_indexed.call(null, function(a, b) {
  return cljs.core.hash_map.call(null, b, a)
}, x_ids_68776)), Y_indexes_68781 = cljs.core.reduce.call(null, cljs.core.merge, cljs.core.map_indexed.call(null, function(a, b) {
  return cljs.core.hash_map.call(null, b, a)
}, y_ids_68777));
slopegraph.main.svg.selectAll("g.X").data(cljs.core.vec.call(null, x_ids_68776)).enter().append("svg:text").attr(cljs.core.ObjMap.fromObject(["\ufdd0'x", "\ufdd0'y", "\ufdd0'dy", "\ufdd0'font-size", "\ufdd0'text-anchor"], {"\ufdd0'x":slopegraph.main.m.call(null, 1), "\ufdd0'y":function(a) {
  return ya_68778.call(null, X_indexes_68780.call(null, a))
}, "\ufdd0'dy":".35em", "\ufdd0'font-size":10, "\ufdd0'text-anchor":"end"})).text(function(a) {
  return[cljs.core.str(a), cljs.core.str("("), cljs.core.str(slopegraph.main.X.call(null, a)), cljs.core.str(")")].join("")
});
slopegraph.main.svg.selectAll("g.Y").data(cljs.core.vec.call(null, y_ids_68777)).enter().append("svg:text").attr(cljs.core.ObjMap.fromObject(["\ufdd0'x", "\ufdd0'y", "\ufdd0'dy", "\ufdd0'font-size", "\ufdd0'text-anchor"], {"\ufdd0'x":slopegraph.main.w - slopegraph.main.m.call(null, 3), "\ufdd0'y":function(a) {
  return ya_68778.call(null, Y_indexes_68781.call(null, a))
}, "\ufdd0'dy":".35em", "\ufdd0'font-size":10, "\ufdd0'text-anchor":"left"})).text(function(a) {
  return[cljs.core.str(a), cljs.core.str("("), cljs.core.str(slopegraph.main.Y.call(null, a)), cljs.core.str(")")].join("")
});
slopegraph.main.svg.selectAll(".slopes").data(slopegraph.main.X_Y_adjucency).enter().append("svg:line").attr(cljs.core.ObjMap.fromObject("\ufdd0'x1 \ufdd0'x2 \ufdd0'y1 \ufdd0'y2 \ufdd0'opacity \ufdd0'stroke".split(" "), {"\ufdd0'x1":slopegraph.main.m.call(null, 1) + 15, "\ufdd0'x2":slopegraph.main.w - slopegraph.main.m.call(null, 3) - 15, "\ufdd0'y1":function(a) {
  return ya_68778.call(null, X_indexes_68780.call(null, cljs.core.first.call(null, a)))
}, "\ufdd0'y2":function(a) {
  return yb_68779.call(null, Y_indexes_68781.call(null, cljs.core.second.call(null, a)))
